...
import { defaultGraphConfig, fitGraphId, Graph } from "../../src/store/graphs/state";
import { SerialisedGraphsState } from "@/types/serialisationTypes";
...
describe("serialise", () => {
    ...
    const expectedGraphs: SerialisedGraphsState = {
        fitGraph: {
          id: fitGraphId,
          config: {
            selectedVariables: ["S", "I"],
