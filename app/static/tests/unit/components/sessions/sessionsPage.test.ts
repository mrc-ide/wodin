...
describe("SessionsPage", () => {
  ...
  it("renders as expected", () => {
    ...
    expect(session2Cells.at(3)!.find("a").attributes("href")).toBe("http://localhost:3000/apps/testApp/?sessionId=def");
    ...
    expect(session3Cells.at(3)!.find("a").attributes("href")).toBe("http://localhost:3000/apps/testApp/?sessionId=ghi");
