...
describe("Advanced Settings", () => {
  ...
  it("commits update advanced settings without standard form", () => {
    ...
    expect(mockUpdateAdvancedSettings.mock.calls[0][1]).toStrictEqual({ newVal: 2, option: AdvancedOptions.maxSteps });
  });
  ...
  it("commits update advanced settings with standard form", () => {
    ...
    expect(mockUpdateAdvancedSettings).toBeCalledTimes(1);
    expect(mockUpdateAdvancedSettings.mock.calls[0][1]).toStrictEqual({ newVal: [2, 3], option: AdvancedOptions.tol });
  });
