...
test.describe("Sensitivity tests", () => {
  ...
  test("can edit Sensitivity options", async ({ page }) => {
    ...
    await expect(await page.innerText("#sensitivity-options .alert-success")).toBe(" 3.600, 3.689, 3.778, ..., 4.400");
    ...
    await expect(await page.innerText("#edit-param .modal .alert-success")).toBe(" 3.600, 3.689, 3.778, ..., 4.400");
    ...
    await expect(await page.innerText("#sensitivity-options .alert-success")).toBe(" 1.000, 1.158, 1.340, ..., 5.000");
  });
