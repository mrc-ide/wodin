            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="min-height: 26rem">
                        <div class="row" id="edit-param-to-vary">
                            ...
                            <div class="col-6">
                                ...
                                <div v-else class="col-form-label param-name-label">
                                    {{ settingsInternal.parameterToVary }}
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2" id="edit-variation-type">
                            ...
                            <div class="col-6">
                                <select class="form-select" v-model="settingsInternal.variationType">
                                    <option v-for="variation in variationTypeValues" :key="variation">
                                        {{ variation }}
                                    </option>
                                </select>
                            </div>
                        ...
                        <div v-if="settingsInternal.variationType === 'Percentage'" class="row mt-2" id="edit-percent">
                            ...
                            <div class="col-6">
                                <numeric-input
                                    :value="settingsInternal.variationPercentage"
                                    @update="(n) => (settingsInternal.variationPercentage = n)"
                                ></numeric-input>
                            </div>
                        </div>
                        <div v-if="settingsInternal.variationType === 'Range'" class="row mt-2" id="edit-from">
                            ...
                            <div class="col-6">
                                <numeric-input
                                    :value="settingsInternal.rangeFrom"
                                    @update="(n) => (settingsInternal.rangeFrom = n)"
                                ></numeric-input>
                            </div>
                        </div>
                        <div
                            v-if="['Range', 'Custom'].includes(settingsInternal.variationType)"
                            class="row mt-2 text-muted"
                            id="param-central"
                        >
                            <div class="col-6">Central value</div>
                            <div class="col-6">
                                {{ centralValue }}
                            </div>
                        </div>
                        <div v-if="settingsInternal.variationType === 'Range'" class="row mt-2" id="edit-to">
                            ...
                            <div class="col-6">
                                <numeric-input
                                    :value="settingsInternal.rangeTo"
                                    @update="(n) => (settingsInternal.rangeTo = n)"
                                ></numeric-input>
                            </div>
                        </div>
                        <template v-if="settingsInternal.variationType === 'Custom'">
                            <div id="edit-values" class="row mt-2">
                                ...
                                <div class="col-6">
                                    <tag-input
                                        :tags="settingsInternal.customValues"
                                        :numeric-only="true"
                                        @update="updateCustomValues"
                                    >
                                    </tag-input>
                                </div>
                            </div>
                        ...
                        <div v-if="settingsInternal.variationType !== 'Custom'" id="edit-runs" class="row mt-2">
                            ...
                            <div class="col-6">
                                <numeric-input
                                    :value="settingsInternal.numberOfRuns"
                                    @update="(n) => (settingsInternal.numberOfRuns = n)"
                                ></numeric-input>
                            </div>
                        </div>
                        ...
                        <sensitivity-param-values
                            v-if="settingsInternal.variationType !== 'Custom'"
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-outline" id="cancel-settings" @click="close">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
