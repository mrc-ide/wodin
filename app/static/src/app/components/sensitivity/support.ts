...
export const sensitivityUpdateRequiredExplanation = (reasons: SensitivityUpdateRequiredReasons,
    multiSens: boolean): string => {
    ...
    appendIf(explanation, reasons.sensitivityOptionsChanged && !reasons.modelChanged,
