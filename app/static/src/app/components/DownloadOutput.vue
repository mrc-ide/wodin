      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content px-2">
          ...
          <div class="modal-footer">
            <button class="btn btn-primary" :disabled="!canDownload" id="ok-download" @click="downloadOutput">
              OK
            </button>
            <button class="btn btn-outline" id="cancel-download" @click="closeModal">Cancel</button>
          </div>
        </div>
      </div>
    </div>
