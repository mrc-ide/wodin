...
export function discreteSeriesSetToPlotly(s: DiscreteSeriesSet, palette: Palette,
    includeIndividual: boolean): WodinPlotData {
    const individualLegends: string[] = [];
    const series = includeIndividual ? s.values
